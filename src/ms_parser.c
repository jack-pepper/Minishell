...
/*   Updated: 2025/03/28 01:04:56 by mmalie           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*copy_collapse(char *dst, char *src, size_t dst_len, size_t src_len)
{
	int	i;
	int	j;
...
char	*ft_strcollapse(char *line)
{
	...
	if (!collapsed_line)
		return (NULL);
	collapsed_line = copy_collapse(collapsed_line, line, line_len - to_collapse, line_len);
...
char	*ft_normalize(char *line)
{
	...
	normalized_line = ft_strcollapse(trimmed_line, " \f\n\r\t\v");
